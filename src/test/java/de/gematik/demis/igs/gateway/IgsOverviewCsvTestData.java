...
public class IgsOverviewCsvTestData {

  public static final SimpleDateFormat formatter =
      new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault());
  public static final String FAKE_DEMIS_NOTIFICATION_ID = "00000000-0000-0000-0000-000000000000";
  public static IgsOverviewCsv.IgsOverviewCsvBuilder firstRow;
  public static IgsOverviewCsv.IgsOverviewCsvBuilder secondRow;
  public static IgsOverviewCsv.IgsOverviewCsvBuilder thirdRow;

  static {
    firstRow =
        IgsOverviewCsv.builder()
            ...
            .status("final")
            .dateOfSampling("2022-05-18")
            .dateOfReceiving("2023-03-03")
            .dateOfSequencing("2022-09-29")
    ...
    thirdRow =
        IgsOverviewCsv.builder()
            ...
            .status("amended")
            .dateOfSampling("2023-01-24")
            .dateOfReceiving("2023-03-03")
            .dateOfSequencing("2023-08-24")
            .sequencingInstrument("NextSeq_500")
            .sequencingPlatform("ILLUMINA")
            .adapterSubstance("CTGTCTCTTATACACATCT+ATGTGTATAAGAGACA")
            .primerSchemeSubstance("SchemeXYZ v3.5")
   ...
   */
  public static List<IgsOverviewCsv> determineTestOverviewData() {
   ...
   * @return The expected overview data.
   */
  public static List<IgsOverviewCsv> determineExpectedOverviewData() throws ParseException {
    final IgsOverviewCsv firstRow =
        IgsOverviewCsv.builder()
            .meldetatbestand("SPNP")
            .speciesCode("840533007")
            .species("Severe acute respiratory syndrome coronavirus 2 (organism)")
            ...
            .rowNumber(1)
            .build();
    final IgsOverviewCsv secondRow =
        IgsOverviewCsv.builder()
            .meldetatbestand("SPNP")
            .speciesCode("840533007")
            .species("Severe acute respiratory syndrome coronavirus 2 (organism)")
